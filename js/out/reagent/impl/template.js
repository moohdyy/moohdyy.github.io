...
return cljs.core._write(writer__4889__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4309__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4309__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4309__auto__)){
return or__4309__auto__;
} else {
...
var G__10667 = o;
(G__10667[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
while (G__10669__i < G__10669__a.length) {G__10669__a[G__10669__i] = arguments[G__10669__i + 0]; ++G__10669__i;}
  args = new cljs.core.IndexedSeq(G__10669__a,0);
} 
...
var old_10671 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_10671))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_10671)].join(''):class$));
} else {
}
...
var res = (function (){var G__10673 = e;
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__10673) : on_change.call(null,G__10673));
})();
...
var G__10676 = jsprops;
(G__10676["defaultValue"] = value);

(G__10676["onChange"] = ((function (G__10676,v,value,on_change){
return (function (p1__10674_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10674_SHARP_);
});})(G__10676,v,value,on_change))
);
...
var G__10677 = argv;
var G__10678 = comp;
var G__10679 = jsprops;
var G__10680 = first_child;
return (reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4 ? reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4(G__10677,G__10678,G__10679,G__10680) : reagent.impl.template.make_element.call(null,G__10677,G__10678,G__10679,G__10680));
})], null);
...
var G__10685 = argv;
var G__10686 = comp;
var G__10687 = jsprops;
var G__10688 = first_child;
return (reagent.impl.template.reagent_input_class.cljs$core$IFn$_invoke$arity$4 ? reagent.impl.template.reagent_input_class.cljs$core$IFn$_invoke$arity$4(G__10685,G__10686,G__10687,G__10688) : reagent.impl.template.reagent_input_class.call(null,G__10685,G__10686,G__10687,G__10688));
});
reagent.impl.template.parse_tag = (function reagent$impl$template$parse_tag(hiccup_tag){
var vec__10690 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10690,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10690,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10690,(2),null);
...
var temp__4427__auto__ = (function (){var G__10692 = cljs.core.meta(v);
var G__10692__$1 = (((G__10692 == null))?null:reagent.impl.template.get_key(G__10692));
return G__10692__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__10694_10695 = v;
var G__10694_10696__$1 = (((G__10694_10695 == null))?null:reagent.impl.template.key_from_vec(G__10694_10695));
var G__10694_10697__$2 = (((G__10694_10696__$1 == null))?null:(jsprops["key"] = G__10694_10696__$1));
...
var G__10705 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10705) : reagent.impl.template.as_element.call(null,G__10705));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__10706 = cljs.core.meta(argv);
var G__10706__$1 = (((G__10706 == null))?null:reagent.impl.template.get_key(G__10706));
return G__10706__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__10707 = (((jsprops == null))?{}:jsprops);
(G__10707["key"] = key);
...
var G__10709 = comp;
var G__10710 = p;
var G__10711 = first_child;
return (reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4 ? reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4(G__10708,G__10709,G__10710,G__10711) : reagent.impl.template.make_element.call(null,G__10708,G__10709,G__10710,G__10711));
}
} else {
return null;
}
...
var G__10714 = x;
return (reagent.impl.template.expand_seq_check.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.expand_seq_check.cljs$core$IFn$_invoke$arity$1(G__10714) : reagent.impl.template.expand_seq_check.call(null,G__10714));
...
var n__5194__auto___10716 = a.length;
var i_10717 = (0);
while(true){
if((i_10717 < n__5194__auto___10716)){
(a[i_10717] = reagent.impl.template.as_element((a[i_10717])));

var G__10718 = (i_10717 + (1));
i_10717 = G__10718;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5194__auto___10719 = a.length;
var i_10720 = (0);
while(true){
if((i_10720 < n__5194__auto___10719)){
var val_10721 = (a[i_10720]);
if((cljs.core.vector_QMARK_(val_10721)) && ((reagent.impl.template.key_from_vec(val_10721) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10720] = reagent.impl.template.as_element(val_10721));
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__10724){
