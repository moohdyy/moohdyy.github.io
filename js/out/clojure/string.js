...
return s.replace((new RegExp((function (){var G__10622 = match;
return goog.string.regExpEscape(G__10622);
})(),"g")),replacement);
} else {
...
while(true){
if(coll__$1){
var G__10626 = sb.append([cljs.core.str(cljs.core.first(coll__$1))].join(''));
var G__10627 = cljs.core.next(coll__$1);
sb = G__10626;
coll__$1 = G__10627;
continue;
} else {
...
var G__10630 = cljs.core.pop(v__$1);
v__$1 = G__10630;
continue;
} else {
return v__$1;
...
var expr__10639 = limit;
if(cljs.core.truth_((function (){var G__10641 = (1);
...
if(cljs.core.truth_((function (){var G__10643 = (2);
var G__10644 = expr__10639;
return (pred__10638.cljs$core$IFn$_invoke$arity$2 ? pred__10638.cljs$core$IFn$_invoke$arity$2(G__10643,G__10644) : pred__10638.call(null,G__10643,G__10644));
})())){
...
var G__10648 = s__$1.substring((index + cljs.core.count(m)));
var G__10649 = (limit__$1 - (1));
var G__10650 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__10648;
limit__$1 = G__10649;
parts = G__10650;
continue;
...
var G__10652 = s;
return goog.string.trim(G__10652);
});
/**
...
var G__10654 = s;
return goog.string.trimLeft(G__10654);
});
/**
...
var G__10656 = s;
return goog.string.trimRight(G__10656);
});
/**
...
var G__10659 = s;
return goog.string.isEmptySafe(G__10659);
});
/**
...
var temp__4423__auto___10660 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);
if(cljs.core.truth_(temp__4423__auto___10660)){
var replacement_10661 = temp__4423__auto___10660;
buffer.append([cljs.core.str(replacement_10661)].join(''));
} else {
buffer.append(ch);
}
